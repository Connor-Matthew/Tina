          ...
          {message.role === "user" ? (
            <>
              ...
              <button
                ...
                onClick={() =>
                  void onResendMessage(conversation.id, message.id)
                }
              >
                <svg
                  viewBox="0 0 24 24"
...
export const ConversationView = memo(function ConversationView({
  ...
  if (!conversation || (conversation.messages.length === 0 && !isSending)) {
    return (
        ...
        <div className="welcome">
            ...
            <div className="welcome__logo">
              ...
              >
                <rect
                  ...
                  height="48"
                  rx="12"
                  fill="url(#tina-gradient)"
                />
                <path
                  d="M14 18h20v3H14v-3zm0 9h14v3H14v-3z"
                  fill="white"
                  fillOpacity="0.9"
                />
                <defs>
          ...
          <div className="welcome__content">
            ...
            <p className="welcome__description">
              I'm here to assist with coding, writing, analysis, and creative
              tasks. Start a conversation below to begin.
            </p>
          </div>
